...
public class LocacaoServiceTest {
	...
	public void deveAlugarFilme() throws Exception {
		...
		// verificao
		// checkThat checa todos os teste e não para no primeiro quando da erro como o
		// assertThat
	...
	public void devePagar25PorCentroNoFilme5() throws FilmeSemEstoqueExption, LocadoraException {
		...
		// verificacao
		// (f1=4)+(f2=4)+(f3=3 com desconto 75)+(f4=2 com desconto de 50)+(f5=1 com
		// desconto de 25) = 14
	...
	public void naoDeveDevolverFilmeNoDomingo() throws FilmeSemEstoqueExption, LocadoraException {
		...
		// Assumebasically significa "não execute este teste se estas condições não se
		// aplicarem"
